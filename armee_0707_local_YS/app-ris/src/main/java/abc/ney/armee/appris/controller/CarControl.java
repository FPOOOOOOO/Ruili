...
public class CarControl {
    ...
    public BaseResp<String> addLockInfo(Long deviceId, Long driverId, String st, String et, Boolean downed) {
        try {
            ...
            lockAuthInfo.setDriverId(driverId);
            lockAuthInfo.setDeviceId(deviceId);
            lockAuthInfo.setEndTime(etimestamp);
            lockAuthInfo.setStartTime(stimestamp);
            lockAuthInfo.setDowned(downed);
